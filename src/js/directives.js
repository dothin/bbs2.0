 ...
 */
var myBbsDirectives = angular.module('myBbsDirectives', []);
myBbsDirectives.directive('validatePassword', [function () {
    return {
        require: "ngModel",
...
myBbsDirectives.directive("repeat", [function () {
    return {
        restrict: 'A',
        require: "ngModel",
...
myBbsDirectives.directive('ckeditor', function() {
    return {
        require : '?ngModel',
...
myBbsDirectives.directive('tmPagination', [function () {
    return {
        restrict: 'EA',
        template: '<div class="page-list clearfix mb20">' + '<ul class="pagination" ng-show="conf.totalItems > 0">'
        ...
        + '<div class="page-total hidden-xs" ng-show="conf.totalItems > 0">'
